 ...
 * <p>
 * Vehicle 클래스를 참고하여, Car, Bicycle, Motorcycle 클래스를 구현하도록 만들어보세요. 해당 예제는 의도적으로 오류가 발생하도록 구성되었으며,
 * Vehicle을 상속하지 않은 클래스는 오류가 발생합니다.
 */
public class AbstractionExample {
    ...
    static class Motorcycle extends Vehicle {
        ...
        @Override
        public void run() {
            System.out.println("motercycle is running");
        }
    }
}
